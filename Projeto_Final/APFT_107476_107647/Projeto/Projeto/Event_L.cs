    ...
    public class Event_L
    {
        ...
        public String N_tickets_public
        {
            ...
            set
            {
                ...
                {
                    throw new Exception("N_TIckets_public tickets field can’t be empty or 0");
                    return;
                }
        ...
        public String Location_Name
        {
            ...
            set
            {
                if (value == null | String.IsNullOrEmpty(value))
                {
                    throw new Exception("Location_ID field can’t be empty ");
                    return;
                }
        ...
        {
            string formattedString = $"{_eventID,-5} {_eventName,-30} {_supplier_name,-25} {_sponsor_name,-25} {_organizer_name,-25}";
